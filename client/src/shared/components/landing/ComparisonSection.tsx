            ...
            <div className="container mx-auto px-6">
                <div className="text-center max-w-3xl mx-auto mb-16">
                    <h2 className="text-3xl md:text-5xl font-black uppercase tracking-tighter mb-6 text-foreground">
                        El costo del <span className="text-brand-red">Caos</span> vs El valor del <span className="text-emerald-600 dark:text-emerald-400">Control</span>
                    </h2>
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    {/* The Chaos */}
                    <div className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-800/50 border-2 border-red-100 dark:border-red-900/20 flex flex-col h-full">
                        <div className="mb-8 p-3 w-fit rounded-xl bg-red-100 dark:bg-red-900/30 text-red-600 dark:text-red-400">
                            <X size={28} />
                        </div>
                    ...
                    {/* The Control */}
                    <div className="p-8 rounded-3xl bg-emerald-50/30 dark:bg-emerald-900/10 border-2 border-emerald-100 dark:border-emerald-900/20 flex flex-col h-full ring-2 ring-emerald-500/5">
                        <div className="mb-8 p-3 w-fit rounded-xl bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600 dark:text-emerald-400">
                            <Check size={28} />
                        </div>
