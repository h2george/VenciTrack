...
const labelVariants = cva("text-[10px] font-black uppercase tracking-widest text-muted-foreground leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70")
